...
// Funciones 
    ...
    // Aqui indicamos que si el item con el id es diferente al id que se le esta dando , lo agregue al carrito            
    ...
    function checkout(){
        for (const item of cart){
        const productFinder = db.find(p => p.id === item.id)
        // restamos la cantidad que mantiene la BBDD y le restamos la cantidad que mantiene el carrito
